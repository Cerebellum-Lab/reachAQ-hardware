...
class JogButtons(Widget):
    ...
    def __init__(
        ...
        small_jog_size: int,
        big_jog_size: int,
        max_jog_velocity: int,
        max_jog_acceleration: int,
        **kwargs
    ):
        """
        ...
        super().__init__(
            id=to_valid_identifier(widget_name), classes="jog-buttons", **kwargs
        )
        ...
        self.move = partial(
            move,
            max_velocity=self.max_jog_velocity,
            max_acceleration=self.max_jog_acceleration,
            abs_or_rel=AbsOrRel.RELATIVE,
        )

        # Define jog buttons for directional movement, providing options for big and small steps
        self.jog_left_big_button = GlitchlessButton(
            "<<",
            id="jog-left-big-button",
            classes="jog-button",
            action=self.jog_left_big_action,
        )
        self.jog_left_small_button = GlitchlessButton(
            "<",
            id="jog-left-small-button",
            classes="jog-button",
            action=self.jog_left_small_action,
        )
        self.jog_right_big_button = GlitchlessButton(
            ">>",
            id="jog-right-big-button",
            classes="jog-button",
            action=self.jog_right_big_action,
        )
        self.jog_right_small_button = GlitchlessButton(
            ">",
            id="jog-right-small-button",
            classes="jog-button",
            action=self.jog_right_small_action,
        )
    ...
    def compose_jog_buttons(self):
        ...
        jog_buttons_container = Horizontal(
            self.jog_left_big_button,
            self.jog_left_small_button,
            self.jog_right_small_button,
            self.jog_right_big_button,
            classes="jog-button-container",
        )
