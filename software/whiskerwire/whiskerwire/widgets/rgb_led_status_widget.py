...
class RGBLEDStatusWidget(StatusWidget):
    class InternalStatic(Static):
        def __init__(self, master: StatusWidget, renderable="", *, expand=False, shrink=False, markup=True, name=None,
    ...
    def __init__(self, model: RGBLEDModel, write: callable, **kwargs):
        ...
        self.color_display_widget = GlitchlessButton("", disabled=False, action=self.__toggle_selected,
        ...
        self.green_display_widget = self.InternalStatic(self, f"Green: {self.model.green}%",
                                                        classes="rgb-status-display")
        ...
        self.command_value_widget = CommandValueWidget("Set Color", ["Red", "Green", "Blue"],
