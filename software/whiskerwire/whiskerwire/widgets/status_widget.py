...
class StatusWidget(Widget):
    ...
    def __init__(self, widget_name: str, instance: int, **kwargs):
        ...
        Widget.__init__(self, id=to_valid_identifier(widget_name), classes="status-widget", **kwargs)
        self.instance = instance
        self.widget_name = widget_name
        self.items: list[Widget] = []  # List of child widgets representing status items
        self.hidable_items: list[Widget] = []  # List of items that can be hidden (for conditional display)
