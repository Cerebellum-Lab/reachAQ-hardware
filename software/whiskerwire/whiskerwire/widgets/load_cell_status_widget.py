...
from ..model.models.driver_models.sensors.load_cell_sensor_model import (
    LoadCellSensorModel,
)
...
class LoadCellStatusWidget(SensorStatusWidget):
    ...
    def __init__(self, model: LoadCellSensorModel, tare: callable, **kwargs):
        ...
        self.tare_button = GlitchlessButton(
            "Tare",
            classes="tare-button",
            action=partial(tare, instance=self.model.instance),
        )
