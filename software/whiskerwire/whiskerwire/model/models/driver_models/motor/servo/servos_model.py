...
class ServosModel(MotorsModel):
    ...
    def update_from_cfg_message(self, msg: JerryCANCfgMsg.ServoCfg):
        ...
        servo = self.get_motor(msg.motor_id)
        if servo is not None:
            servo.min_position, servo.max_position, servo.min_pwm_duration_us, servo.max_pwm_duration_us, servo.max_velocity, servo.max_acceleration = msg.min_position, msg.max_position, msg.min_pwm_duration_us, msg.max_pwm_duration_us, msg.max_velocity, msg.max_acceleration
