...
class RGBLEDModel:
    ...
    def red(self, value: int):
        if not self.is_valid_value(value):
            raise ValueError(f"Invalid red value: must be on the interval [{MIN_RGB_VALUE}, {MAX_RGB_VALUE}]")
    ...
    def green(self, value: int):
        if not self.is_valid_value(value):
            raise ValueError(f"Invalid green value: must be on the interval [{MIN_RGB_VALUE}, {MAX_RGB_VALUE}]")
    ...
    def blue(self, value: int):
        if not self.is_valid_value(value):
            raise ValueError(f"Invalid blue value: must be on the interval [{MIN_RGB_VALUE}, {MAX_RGB_VALUE}]")
